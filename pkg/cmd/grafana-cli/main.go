...
import (
	...
	"github.com/mareebsiddiqui/grafana/pkg/cmd/grafana-cli/commands"
	"github.com/mareebsiddiqui/grafana/pkg/cmd/grafana-cli/logger"
	"github.com/mareebsiddiqui/grafana/pkg/cmd/grafana-cli/services"
	"github.com/mareebsiddiqui/grafana/pkg/cmd/grafana-cli/utils"
)
...
func main() {
	...
	app.Email = "https://github.com/mareebsiddiqui/grafana"
	app.Version = version
	app.Flags = []cli.Flag{
		cli.StringFlag{
			Name:   "pluginsDir",
