...
We plan to add many more macros. If you have suggestions for what macros you would like to see, please [open an issue](https://github.com/mareebsiddiqui/grafana) in our GitHub repo.
