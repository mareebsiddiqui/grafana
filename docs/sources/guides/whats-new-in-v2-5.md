...
- Check out [#2353](https://github.com/mareebsiddiqui/grafana/issues/2353) for more info.
...
view the [CHANGELOG.md](https://github.com/mareebsiddiqui/grafana/blob/master/CHANGELOG.md) file.
